...
(defun repl/turn-on-evil-keybindings nil
  (interactive)
  (map! :map repl-shell-mode-map :leader :n "r&" #'repl/shell-start)
  (map! :map repl-shell-mode-map :leader :n "rQ" #'repl/shell-kill)
  (map! :map repl-shell-mode-map :leader :n "rS" #'repl/shell-split)
  (map! :map repl-shell-mode-map :leader :n "rV" #'repl/shell-vsplit)
  (map! :map repl-shell-mode-map :leader :n "rK" #'repl/shell-hide)
  (map! :map repl-shell-mode-map :leader :n "rL" #'repl/shell-send-line)
  (map! :map repl-shell-mode-map :leader :v "rR" #'repl/shell-send-region)
  (map! :map repl-shell-mode-map :leader :n "rB" #'repl/shell-send-buffer)
  (map! :map repl-shell-mode-map :leader :n "r>" #'repl/shell-send-till-point)
  (map! :map repl-shell-mode-map :leader :n "rI" #'repl/shell-send-string)
  (map! :map repl-shell-mode-map :leader :n "rC" #'repl/shell-send-eof)
  (map! :map repl-shell-mode-map :leader :n "rE" #'repl/shell-send-sexp)
  (map! :map repl-shell-mode-map :leader :n "rD" #'repl/shell-send-defun)
  (map! :map repl-mode-map :leader :n "r!" #'repl/start)
  (map! :map repl-mode-map :leader :n "rq" #'repl/kill)
  (map! :map repl-mode-map :leader :n "rs" #'repl/split)
  (map! :map repl-mode-map :leader :n "rv" #'repl/vsplit)
  (map! :map repl-mode-map :leader :n "rk" #'repl/hide)
  (map! :map repl-mode-map :leader :n "rl" #'repl/send-line)
  (map! :map repl-mode-map :leader :v "rr" #'repl/send-region)
  (map! :map repl-mode-map :leader :n "rb" #'repl/send-buffer)
  (map! :map repl-mode-map :leader :n "r." #'repl/send-till-point)
  (map! :map repl-mode-map :leader :n "ri" #'repl/send-string)
  (map! :map repl-mode-map :leader :n "rc" #'repl/send-eof)
  (map! :map repl-mode-map :leader :n "rd" #'repl/send-defun)
  (map! :map repl-mode-map :leader :n "re" #'repl/send-sexp)
  (map! :map repl-mode-map :leader :n "r," #'repl::ivy/running)
  (map! :map repl-mode-map :leader :n "r`" #'repl::ivy/start))

(defun repl/turn-off-evil-keybindings nil
  (interactive)
  (map! :map repl-shell-mode-map :leader :n "r&" nil)
  (map! :map repl-shell-mode-map :leader :n "rQ" nil)
  (map! :map repl-shell-mode-map :leader :n "rS" nil)
  (map! :map repl-shell-mode-map :leader :n "rV" nil)
  (map! :map repl-shell-mode-map :leader :n "rK" nil)
  (map! :map repl-shell-mode-map :leader :n "rL" nil)
  (map! :map repl-shell-mode-map :leader :v "rR" nil)
  (map! :map repl-shell-mode-map :leader :n "rB" nil)
  (map! :map repl-shell-mode-map :leader :n "r>" nil)
  (map! :map repl-shell-mode-map :leader :n "rI" nil)
  (map! :map repl-shell-mode-map :leader :n "rC" nil)
  (map! :map repl-shell-mode-map :leader :n "rE" nil)
  (map! :map repl-shell-mode-map :leader :n "rD" nil)
  (map! :map repl-mode-map :leader :n "r!" nil)
  (map! :map repl-mode-map :leader :n "rq" nil)
  (map! :map repl-mode-map :leader :n "rs" nil)
  (map! :map repl-mode-map :leader :n "rv" nil)
  (map! :map repl-mode-map :leader :n "rk" nil)
  (map! :map repl-mode-map :leader :n "rl" nil)
  (map! :map repl-mode-map :leader :v "rr" nil)
  (map! :map repl-mode-map :leader :n "rb" nil)
  (map! :map repl-mode-map :leader :n "r." nil)
  (map! :map repl-mode-map :leader :n "ri" nil)
  (map! :map repl-mode-map :leader :n "rc" nil)
  (map! :map repl-mode-map :leader :n "rd" nil)
  (map! :map repl-mode-map :leader :n "re" nil)
  (map! :map repl-mode-map :leader :n "r," nil)
  (map! :map repl-mode-map :leader :n "r`" nil))
